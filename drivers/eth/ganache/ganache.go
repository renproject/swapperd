...
import (
	...
	eth "github.com/republicprotocol/atom-go/adapters/clients/eth"
)
...
func deployEthSwap(ctx context.Context, conn eth.Connection, auth *bind.TransactOpts) (*bindings.Atom, common.Address, error) {
	address, tx, ethAtom, err := bindings.DeployAtom(auth, conn.Client)
	if err != nil {
