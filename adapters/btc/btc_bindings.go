...
func initiate(connection Connection, participantAddress string, value int64, hash []byte, lockTime int64) (BitcoinData, error) {
...
func redeem(connection Connection, contract, contractTxBytes []byte, secret [32]byte) (redeemResult, error) {
...
func buildContract(connection Connection, args *contractArgs) (*builtContract, error) {
