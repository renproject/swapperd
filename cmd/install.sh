...
if [ "$ostype" = 'Linux' -a "$cputype" = 'x86_64' ]; then
  curl -Ls 'https://github.com/renproject/swapperd/releases/download/v1.0.0-beta.3/swapper_linux_amd64.zip' > swapper.zip
elif [ "$ostype" = 'Darwin' -a "$cputype" = 'x86_64' ]; then
  curl -Ls 'https://github.com/renproject/swapperd/releases/download/v1.0.0-beta.3/swapper_darwin_amd64.zip' > swapper.zip
else
